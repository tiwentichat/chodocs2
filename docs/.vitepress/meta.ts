...
// base info
export const name = 'GetOffer.Help'
export const site = 'https://getoffer.help/'
export const logo = 'https://getoffer.help/chodocs-logo.svg'
...
// social link
export const bilibili = 'https://space.bilibili.com/3493116218706655'
export const github = 'https://github.com/getofferhelp/getofferhelp'
